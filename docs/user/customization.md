...
For the curious, check out the [implementation of CustomRegexScopeHandler](/cursorless/packages/cursorless-engine/src/processTargets/modifiers/scopeHandlers/RegexScopeHandler.ts)
