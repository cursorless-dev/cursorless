...
- `cursorless.<hatStyle>.enabled`: Whether to enable `<hatStyle>` shape / color.  Note that you'll also want to [enable / disable](https://github.com/pokey/cursorless-talon/blob/master/docs/customization.md) the corresponding spoken form in Talon.
