...
import { CompositeKeyMap, HatStability, TokenHat } from "../common";

// Inline replacements for lodash memoize and min — avoids bundling the full
// lodash CommonJS module (5,500 lines) which blows QuickJS's call stack.
...
function min(arr: number[]): number | undefined {
