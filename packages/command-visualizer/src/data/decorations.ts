...
// same band hex family; per-edge borders are not modeled here).
export const DECORATION_HEX: Record<OverlayStyleName, string> = {
  pendingDelete: "#ff00008a",
  justAdded: "#09ff005b",
  referenced: "#00a2ff4d",
...
// cadence. Both the delete (pendingDelete) and insert
...
// Single-winner precedence: selection < highlight < flash, last wins; exactly
// ONE background per cell. Higher number wins.
