...
suite("sentence-parser: Preserve whitespace", () => {
  suite("Basic", () => {
    const entry =
    ...
    test("funny whitespace is preserved in the sentences", () => {
  ...
  suite("No effect if newline_boundaries are specified", () => {
    ...
    test("funny whitespace is not preserved when newline_boundaries is specified", () => {
