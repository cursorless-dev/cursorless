...
- **Move where destination contains source**: More flexible move action behavior ([#3056](https://github.com/cursorless-dev/cursorless/pull/3056))
- **From action enabled by default** ([#2939](https://github.com/cursorless-dev/cursorless/pull/2939))
- **Next/previous support for custom commands** ([#2969](https://github.com/cursorless-dev/cursorless/pull/2969))

### Documentation and visualization improvements

The docs got some serious love this cycle:

- **Scope test visualization**: The [language pages](https://www.cursorless.org/docs/user/languages) now show visualizations of scope tests, making it easier to understand exactly what each scope targets ([#3016](https://github.com/cursorless-dev/cursorless/pull/3016))
...
- Changed interior scope handler priority to favor surrounding pair interiors ([#3068](https://github.com/cursorless-dev/cursorless/pull/3068))
...
### Support for VS Code forks

Cursorless now supports VS Code forks like VSCodium:

- Added sandbox setup command for VSCodium ([#2989](https://github.com/cursorless-dev/cursorless/pull/2989))
- Updated install scripts to support VS Code forks ([#3096](https://github.com/cursorless-dev/cursorless/pull/3096))

## 📈 What's next?

- **Cursorless everywhere**: We're continuing work on bringing Cursorless to more editors and platforms.
- **Embedded languages**: Support for embedded languages like JavaScript within HTML, markdown code blocks, vue.js, styled components, etc. remains a priority ([#409](https://github.com/cursorless-dev/cursorless/issues/409))
