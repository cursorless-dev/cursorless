...
suite("sentence-parser: Preserve whitespace", function () {
  suite("Basic", function () {
    ...
    const sentences = parser.sentences(entry, options);
  ...
  //   suite("No effect if html_boundaries are specified", function () {
  //     const entry = " This is\ta  sentence   with  funny whitespace. ";
  //     const sentences = tokenizer.sentences(
  //       entry,
  //       Object.assign({ htmlBoundaries: true }, options),
  //     );
  ...
  //     test("funny whitespace is not preserved when html_boundaries is specified", function () {
  //       assert.equal(sentences[0], "This is a sentence with funny whitespace.");
  //     });
  //   });
