...
import recordedTests from "./fixtures/ordinalScope.json";
...
<RecordedTestVisualizer fixtureName="docs/modifiers/ordinalScope" />

### `"take last item"`

<RecordedTestVisualizer fixtureName="docs/modifiers/ordinalScope2" />

### `"take first two items"`

<RecordedTestVisualizer fixtureName="docs/modifiers/ordinalScope3" />

### `"take last two items"`

<RecordedTestVisualizer fixtureName="docs/modifiers/ordinalScope4" />

### `"take first past second item"`

<RecordedTestVisualizer fixtureName="docs/modifiers/ordinalScope5" />

### `"take second past third item"`

<RecordedTestVisualizer fixtureName="docs/modifiers/ordinalScope6" />
