...
import recordedTests from "./fixtures/basic-coding.json";
...
<RecordedTestVisualizer fixtureName="tutorial/basic-coding/cloneStateInk" />
...
<RecordedTestVisualizer fixtureName="tutorial/basic-coding/chuckArgueBlueVest" />
