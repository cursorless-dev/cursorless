...
[Start Introduction](./introduction.mdx) - This tutorial will teach you the basics of Cursorless.

## 2. Basic coding

[Start Basic coding](./basic-coding.mdx) - This tutorial will teach you the basics of coding with Cursorless.
