...
import recordedTests from "./fixtures/editNewLineBefore.json";
...
<RecordedTestVisualizer fixtureName="docs/actions/editNewLineBefore" />

### `"drink token air"`

<RecordedTestVisualizer fixtureName="docs/actions/editNewLineBefore2" />
