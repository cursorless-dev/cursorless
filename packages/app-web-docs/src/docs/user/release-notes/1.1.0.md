...
- **Language-specific scope visualizations in docs**: The [language pages](../languages/README.md) now show visualizations of what each scope looks like in each language, making it easier to understand exactly what each scope targets ([#3016](https://github.com/cursorless-dev/cursorless/pull/3016))
