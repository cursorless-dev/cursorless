...
import { Disposable, IDE } from "../libs/common/ide/types/ide.types";
import ide from "../libs/cursorless-engine/singletons/ide.singleton";
import path = require("path");
import Commands from "../libs/common/ide/types/Commands";
...
export function initializeCheatsheet(commands: Commands): Disposable[] {
  return [
    commands.registerCommand("cursorless.showCheatsheet", showCheatsheet),
 ...
 */
async function updateDefaults(spokenFormInfo: CheatsheetInfo) {
