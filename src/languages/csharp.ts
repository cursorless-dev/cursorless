...
// object_creation_expression is special because its initializer expression is in its initializer field.
const TYPES_WITH_INITIALIZERS_AS_CHILDREN = [
  "array_creation_expression",
  "implicit_array_creation_expression",
  "implicit_object_creation_expression",
  "implicit_stack_alloc_array_creation_expression",
...
const getDictionaryMatchers = {
  dictionary: cascadingMatcher(
    composedMatcher([
      typedNodeFinder(...TYPES_WITH_INITIALIZERS_AS_CHILDREN),
      getInitializerNode      
    ]),
    composedMatcher([
